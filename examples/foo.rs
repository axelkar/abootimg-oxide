use std::{fs::File, io::{self, BufWriter, Read, Seek, SeekFrom}};

use abootimg_oxide::Header;
use binrw::io::BufReader;
fn main() {
    let mut r = BufReader::new(
        File::open("/home/axel/nordce-update/boot_a.img").unwrap(),
    );
    ...
    let r = r.get_mut();
    r.seek(SeekFrom::Start(hdr.kernel_position() as u64)).unwrap();
